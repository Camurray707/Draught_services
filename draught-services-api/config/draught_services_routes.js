...
cycleRouter.get("/recent", Authorize("admin"), CycleController.getRecentCycle, (err) =>
	console.log(`recent cycle ran into an error: ${err}`)
);
...
routesRouter.get("/all-routes", Authorize("admin"), RoutesController.allRoutes, (err) =>
	console.log(`allRoutes ran into an error: ${err}`)
);
routesRouter.get("/all-names", Authorize("admin"), RoutesController.allRouteNames, (err) =>
	console.log(`allRoutes ran into an error: ${err}`)
);
...
marketsRouter.get("/all-markets", Authorize("admin"), MarketsController.allMarkets, (err) =>
	console.log(`allMarkets ran into an error: ${err}`)
);
...
employeesRouter.get("/all-employees", Authorize("admin"), EmployeesController.allEmployees, (err) =>
	console.log(`allEmployees ran into an error: ${err}`)
);
employeesRouter.get(
	"/:employeeID/",
	Authorize("admin"),
	EmployeesController.employeesWithEmployeeID
);
...
accountsRouter.get("/all-accounts", Authorize("admin"), AccountsController.allAccounts, (err) =>
	console.log(`allAccounts ran into an error: ${err}`)
);
...
transactionsRouter.get(
	...
	(err) => console.log(`allTransactions ran into an error: ${err}`)
);
transactionsRouter.get("/summary", Authorize("admin"), TransactionsController.getSummary, (err) =>
	console.log(`allTransactions ran into an error: ${err}`)
);
transactionsRouter.get(
	"/:cycleID/",
	Authorize("admin"),
	TransactionsController.transactionsWithCycleID
);
transactionsRouter.get(
	"/:cycleID/:accountID/one-account",
	Authorize("admin"),
	TransactionsController.transactionsWithAccountID
);
transactionsRouter.get(
	"/:cycleID/:routeID/trans-for-route",
	Authorize("admin"),
	TransactionsController.transactionsWithRouteID
);
transactionsRouter.get(
	"/:cycleID/all-routes",
	Authorize("admin"),
	TransactionsController.allRoutes,
	(err) => console.log(`all-routes ran into an error: ${err}`)
);
transactionsRouter.get(
	"/:cycleID/:marketID/trans-for-market",
	Authorize("admin"),
	TransactionsController.transactionsWithMarketID
);
